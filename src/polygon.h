...
#ifndef __SQLITE_POLYGON_H__
#define __SQLITE_POLYGON_H__
...
/*!
  ...
  @{
*/
/*! \defgroup SQLITE_ELLIPSE_POLY_REL Polygon and ellipse*/
/*!
  \addtogroup SQLITE_ELLIPSE_POLY_REL
  @{
*/
#define SQLITE_ELLIPSE_POLY_AVOID 0    //!< ellipse avoids polygon
#define SQLITE_POLY_CONT_ELLIPSE  1    //!< polygon contains ellipse
#define SQLITE_ELLIPSE_CONT_POLY  2    //!< ellipse contains polygon
#define SQLITE_ELLIPSE_POLY_OVER  3    //!< ellipse overlaps polygon
/*! @} */

/*! \defgroup SQLITE_CIRCLE_POLY_REL Polygon and circle*/
/*!
  \addtogroup SQLITE_CIRCLE_POLY_REL
  @{
*/
#define SQLITE_CIRCLE_POLY_AVOID 0    //!< circle avoids polygon
#define SQLITE_POLY_CONT_CIRCLE  1    //!< polygon contains circle
#define SQLITE_CIRCLE_CONT_POLY  2    //!< circle contains polygon
#define SQLITE_CIRCLE_POLY_OVER  3    //!< circle overlap polygon 
/*! @} */

/*! \defgroup SQLITE_LINE_POLY_REL Polygon and line*/
/*!
  \addtogroup SQLITE_LINE_POLY_REL
  @{
*/
#define SQLITE_LINE_POLY_AVOID   0    //!< line avoids polygon
#define SQLITE_POLY_CONT_LINE    1    //!< polygon contains line
#define SQLITE_LINE_POLY_OVER    2    //!< line overlap polygon 
/*! @} */

/*! \defgroup SQLITE_POLY_REL Polygon and polygon*/
/*!
  \addtogroup SQLITE_POLY_REL
  @{
*/
#define SQLITE_POLY_AVOID        0    //!< polygon avoids other polygon
#define SQLITE_POLY_CONT         1    //!< polygon contains other polygon
#define SQLITE_POLY_OVER         2    //!< polygons overlap
/*! @} */
/*! @} */
...
/*!
	...
	\param poly pointer to polygon
	\return relationship as a \link SQLITE_LINE_POLY_REL long long value \endlink (\ref SQLITE_POLY_LINE_REL )
*/
