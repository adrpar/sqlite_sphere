...
#ifndef __SQLITE_BOX_H__
#define __SQLITE_BOX_H__
...
/*!
	\addtogroup SQLITE_RELATIONSHIPS
	@{
*/
/*! \defgroup SQLITE_BOX_CIRCLE_REL Box and circle */
/*!
	\addtogroup SQLITE_BOX_CIRCLE_REL
	@{
*/
#define SQLITE_BOX_CIRCLE_AVOID 0    //!< box avoids circle
#define SQLITE_BOX_CONT_CIRCLE  1    //!< box contains circle
#define SQLITE_CIRCLE_CONT_BOX  2    //!< circle contains box
#define SQLITE_BOX_CIRCLE_EQUAL 3    //!< circle equals box
#define SQLITE_BOX_CIRCLE_OVER  4    //!< circle and box are overlapping
/*! @} */

/*! \defgroup SQLITE_BOX_LINE_REL Box and line */
/*!
	\addtogroup SQLITE_BOX_LINE_REL
	@{
*/
#define SQLITE_BOX_LINE_AVOID 0    //!< box avoids line
#define SQLITE_BOX_CONT_LINE  1    //!< box contains line
#define SQLITE_BOX_LINE_OVER  2    //!< box and line are overlapping
/*! @} */

/*! \defgroup SQLITE_BOX_PATH_REL Box and path */
/*!
	\addtogroup SQLITE_BOX_PATH_REL
	@{
*/
#define SQLITE_BOX_PATH_AVOID 0    //!< box avoids path
#define SQLITE_BOX_CONT_PATH  1    //!< box contains path
#define SQLITE_BOX_PATH_OVER  2    //!< box and path are overlapping
/*! @} */

/*! \defgroup SQLITE_BOX_POLY_REL Box and polygon */
/*!
	\addtogroup SQLITE_BOX_POLY_REL
	@{
*/
#define SQLITE_BOX_POLY_AVOID 0    //!< box avoids polygon
#define SQLITE_BOX_CONT_POLY  1    //!< box contains polygon
#define SQLITE_POLY_CONT_BOX  2    //!< polygon contains box
#define SQLITE_BOX_POLY_OVER  3    //!< polygon and box are overlapping
/*! @} */

/*! \defgroup SQLITE_BOX_ELLIPSE_REL Box and ellipse */
/*!
	\addtogroup SQLITE_BOX_ELLIPSE_REL
	@{
*/
#define SQLITE_BOX_ELLIPSE_AVOID 0    //!< box avoids ellipse
#define SQLITE_BOX_CONT_ELLIPSE  1    //!< box contains ellipse
#define SQLITE_ELLIPSE_CONT_BOX  2    //!< ellipse contains box
#define SQLITE_BOX_ELLIPSE_OVER  3    //!< ellipse and box are overlapping
/*! @} */


/*! \defgroup SQLITE_BOX_REL Box and box */
/*!
	\addtogroup SQLITE_BOX_REL
	@{
*/
#define SQLITE_BOX_AVOID        0    //!< box avoids other box
#define SQLITE_BOX_CONT         1    //!< box contains other box
#define SQLITE_BOX_OVER         2    //!< boxes are overlapping
/*! @} */
