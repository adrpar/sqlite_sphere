...
#ifndef __SQLITE_ELLIPSE_H__
#define __SQLITE_ELLIPSE_H__
...
/*!
  ...
  @{
*/
/*! \defgroup SQLITE_ELLIPSE_LINE_REL Ellipse and line */
/*!
  \addtogroup SQLITE_ELLIPSE_LINE_REL
  @{
*/
#define SQLITE_ELLIPSE_LINE_AVOID 0    //!< ellipse avoids line
#define SQLITE_ELLIPSE_CONT_LINE  1    //!< ellipse contains line
#define SQLITE_ELLIPSE_LINE_OVER  2    //!< ellipse overlaps line
/*! @} */

/*! \defgroup SQLITE_ELLIPSE_CIRCLE_REL Ellipse and circle */
/*!
  \addtogroup SQLITE_ELLIPSE_CIRCLE_REL
  @{
*/
#define SQLITE_ELLIPSE_CIRCLE_AVOID 0    //!< ellipse avoids circle
#define SQLITE_CIRCLE_CONT_ELLIPSE  1    //!< circle contains ellipse
#define SQLITE_ELLIPSE_CONT_CIRCLE  2    //!< ellipse contains circle
#define SQLITE_ELLIPSE_CIRCLE_EQUAL 3    //!< ellipse equals circle
#define SQLITE_ELLIPSE_CIRCLE_OVER  4    //!< ellipse overlaps circle
/*! @} */

/*! \defgroup SQLITE_ELLIPSE_ELLIPSE_REL Ellipse and ellipse */
/*!
  \addtogroup SQLITE_ELLIPSE_ELLIPSE_REL
  @{
*/
#define SQLITE_ELLIPSE_AVOID 0    //!< ellipse avoids other ellipse
#define SQLITE_ELLIPSE_CONT  1    //!< ellipse contains other ellipse
#define SQLITE_ELLIPSE_OVER  2    //!< ellipse overlaps other ellipse
/*! @} */
/*! @} */
...
/*!
	...
	\return relationship as a \link SQLITE_ELLIPSE_LINE_REL long long value \endlink (\ref  SQLITE_ELLIPSE_LINE_REL )
*/
...
/*!
	...
	\param se pointer to an ellipse
	\return relationship as a \link SQLITE_ELLIPSE_CIRCLE_REL long long value \endlink (\ref  SQLITE_ELLIPSE_CIRCLE_REL )
*/
