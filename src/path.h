...
#ifndef __SQLITE_PATH_H__
#define __SQLITE_PATH_H__
...
/*!
  ...
  @{
*/
/*! \defgroup SQLITE_CIRCLE_PATH_REL Path and circle*/
/*!
  \addtogroup SQLITE_CIRCLE_PATH_REL
  @{
*/
#define SQLITE_CIRCLE_PATH_AVOID 0    //!< circle avoids path
#define SQLITE_CIRCLE_CONT_PATH  1    //!< circle contains path
#define SQLITE_CIRCLE_PATH_OVER  2    //!< circle overlaps path
/*! @} */

/*! \defgroup SQLITE_POLY_PATH_REL Path and polygon*/
/*!
  \addtogroup SQLITE_POLY_PATH_REL
  @{
*/
#define SQLITE_POLY_PATH_AVOID   0    //!< polygon avoids path
#define SQLITE_POLY_CONT_PATH    1    //!< polygon contains path
#define SQLITE_POLY_PATH_OVER    2    //!< polygon and path overlap
/*! @} */

/*! \defgroup SQLITE_ELLIPSE_PATH_REL Path and ellipse*/
/*!
  \addtogroup SQLITE_ELLIPSE_PATH_REL
  @{
*/
#define SQLITE_ELLIPSE_PATH_AVOID 0    //!< ellipse avoids path
#define SQLITE_ELLIPSE_CONT_PATH  1    //!< ellipse contains path
#define SQLITE_ELLIPSE_PATH_OVER  2    //!< ellipse overlaps path
/*! @} */
/*! @} */
