...
#ifndef __SQLITE_SPHERE_SERIALISERHELPER__
#define __SQLITE_SPHERE_SERIALISERHELPER__

#define SQLITE_SPHERE_SERIALISER_SERIALISE( OBJECT, SPHERETYPE, SPHERETYPE_LEN, TAGIDSTART, TAGIDEND ) \
...
#define SQLITE_SPHERE_SERIALISER_GETSERIALISEDLEN( SPHERETYPE_LEN ) \
	if(true) { \
