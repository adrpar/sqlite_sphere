...
#ifndef __SQLITE_LINE_H__
#define __SQLITE_LINE_H__
...
/*!
  \defgroup SQLITE_RELATIONSHIPS Object relationships
  @{
*/
/*! \defgroup SQLITE_CIRCLE_LINE_REL Circle and line
  @{
*/
#define SQLITE_CIRCLE_LINE_AVOID 0    //!< circle avoids line
#define SQLITE_CIRCLE_CONT_LINE  1    //!< circle contains line
#define SQLITE_CIRCLE_LINE_OVER  2    //!< circle overlaps line
/*! @} */

/*! \defgroup SQLITE_LINE_LINE_REL Line and line
  @{
*/
#define SQLITE_LINE_AVOID        1    //!< line avoids other line
#define SQLITE_LINE_EQUAL        2    //!< lines are equal
#define SQLITE_LINE_CONT_LINE    3    //!< line contains line
#define SQLITE_LINE_CROSS        4    //!< lines cross each other
#define SQLITE_LINE_CONNECT      5    //!< line are "connected"  
#define SQLITE_LINE_OVER         6    //!< lines overlap each other
/*! @} */
/*! @} */
...
/*!
	...
	\return relationship as a \link SQLITE_CIRCLE_LINE_REL long long value \endlink (\ref  SQLITE_CIRCLE_LINE_REL )
*/
...
/*!
	...
	\return relationship as a \link SQLITE_LINE_LINE_REL long long value \endlink (\ref  SQLITE_LINE_LINE_REL )
*/
