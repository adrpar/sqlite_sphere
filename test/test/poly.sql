...
SELECT srcontainsl( spoint( '(0.15,0.10)' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );                  -- point inside polygo )n
SELECT srcontainsl( spoint( '(0.20,0.00)' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );                  -- point contained polygon ) 
SELECT srcontainsl( spoint( '(0.10,0.10)' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );                  -- point contained polygon ) 
SELECT srcontainsl( spoint( '(0.25,0.50)' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );                  -- point outside polygon ) 
SELECT srcontainsl( spoint( '(0.25,0.00)' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );                  -- point outside polygon ) 
SELECT srcontainsl( scircle( '<(0.15,0.10),0.03>' ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle inside polygo )n
SELECT srcontainsl( scircle( '<(0.20,0.00),0.00>' ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle contained polygon ) 
SELECT srcontainsl( scircle( '<(0.20,0.30),0.05>' ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle outside  polygon ) 
SELECT srcontainsl( scircle( '<(0.25,0.00),0.05>' ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle overlaps polygo )n
SELECT srcontainsl( scircle( '<(0.25,0.00),0.10>' ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle overlaps polygo )n
SELECT soverlaps( scircle( '<(0.15,0.10),0.03>' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle inside polygo )n
SELECT soverlaps( scircle( '<(0.20,0.00),0.00>' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle contained polygon ) 
SELECT soverlaps( scircle( '<(0.20,0.30),0.05>' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle outside  polygon ) 
SELECT soverlaps( scircle( '<(0.25,0.00),0.05>' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle overlaps polygo )n
SELECT soverlaps( scircle( '<(0.25,0.00),0.10>' ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );          -- circle overlaps polygo )n
SELECT srcontainsl( sline ( spoint( '(0.00, 0.00)' ), spoint( '(0.10,0.20)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygon ) 
SELECT srcontainsl( sline ( spoint( '(0.00, 0.10)' ), spoint( '(0.10,0.10)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygon ) 
SELECT srcontainsl( sline ( spoint( '(0.50, 0.00)' ), spoint( '(0.50,0.20)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygo )n
SELECT srcontainsl( sline ( spoint( '(0.10, 0.20)' ), spoint( '(0.20,0.00)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches and inside polygon ) 
SELECT srcontainsl( sline ( spoint( '(0.45,-0.20)' ), spoint( '(0.45,0.20)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line overlaps polygo )n
SELECT srcontainsl( sline ( spoint( '(0.45, 0.10)' ), spoint( '(0.45,0.20)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line overlaps polygo )n
SELECT srcontainsl( sline ( spoint( '(0.24, 0.17)' ), spoint( '(0.25,0.14)' ) ),  spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line inside  polygo )n
SELECT soverlaps( sline ( spoint( '(0.00, 0.00)' ), spoint( '(0.10,0.20)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygon ) 
SELECT soverlaps( sline ( spoint( '(0.00, 0.10)' ), spoint( '(0.10,0.10)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygon ) 
SELECT soverlaps( sline ( spoint( '(0.50, 0.00)' ), spoint( '(0.50,0.20)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches polygo )n
SELECT soverlaps( sline ( spoint( '(0.10, 0.20)' ), spoint( '(0.20,0.00)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line touches and inside polygon ) 
SELECT soverlaps( sline ( spoint( '(0.45,-0.20)' ), spoint( '(0.45,0.20)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line overlaps polygo )n
SELECT soverlaps( sline ( spoint( '(0.45, 0.10)' ), spoint( '(0.45,0.20)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line overlaps polygo )n
SELECT soverlaps( sline ( spoint( '(0.24, 0.17)' ), spoint( '(0.25,0.14)' ) ), spoly( '{(0.1,0),(0.2,0),(0.2,0.1),(0.3,0.1),(0.3,-0.1),(0.4,-0.1),(0.5,0.1),(0.4,0.2),(0.1,0.2)}' ) );  -- line inside  polygo )n

SELECT sequal( spoly( '{(0,0),(1,0),(0,1)}' ) , spoly( '{(1,0),(0,0),(0,1)}' ) );
SELECT sequal( spoly( '{(1,0),(0,0),(0,1)}' ) , spoly( '{(0,1),(0,0),(1,0)}' ) );
SELECT sequal( spoly( '{(0,1),(0,0),(1,0)}' ) , spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT soverlaps( spoly( '{(0,0),(1,0),(0,1)}' ), spoly( '{(1,0),(0,0),(0,1)}' ) );
SELECT soverlaps( spoly( '{(1,0),(0,0),(0,1)}' ), spoly( '{(0,1),(0,0),(1,0)}' ) );
SELECT soverlaps( spoly( '{(0,1),(0,0),(1,0)}' ), spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT srcontainsl( spoly( '{(0,0),(1,0),(0,1)}' ) , spoly( '{(1,0),(0,0),(0,1)}' ) );
SELECT srcontainsl( spoly( '{(1,0),(0,0),(0,1)}' ) , spoly( '{(0,1),(0,0),(1,0)}' ) );
SELECT srcontainsl( spoly( '{(0,1),(0,0),(1,0)}' ) , spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT srcontainsl( spoly( '{(0,0),(1,0),(0,1)}' ) , spoly( '{(0.1,0.9),(0.1,0.1),(0.9,0.1)}' ) );
SELECT srcontainsl( spoly( '{(0.1,0.9),(0.1,0.1),(0.9,0.1)}' ) , spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT soverlaps( spoly( '{(0,0),(1,0),(0,1)}' ), spoly( '{(0.1,0.9),(0.1,0.1),(0.9,0.1)}' ) );
SELECT soverlaps( spoly( '{(0.1,0.9),(0.1,0.1),(0.9,0.1)}' ), spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT srcontainsl( spoly( '{(0,0),(1,0),(0,1)}' ) , spoly( '{(0.2,0.0),(1.2,0.0),(0.2,1)}' ) );
SELECT srcontainsl( spoly( '{(0.2,0.0),(1.2,0.0),(0.2,1)}' ) , spoly( '{(0,0),(1,0),(0,1)}' ) );
SELECT soverlaps( spoly( '{(0,0),(1,0),(0,1)}' ), spoly( '{(0.2,0.0),(1.2,0.0),(0.2,1)}' ) );
SELECT soverlaps( spoly( '{(0.2,0.0),(1.2,0.0),(0.2,1)}' ), spoly( '{(0,0),(1,0),(0,1)}' ) );

--  From testsuite/poly_test.sql



SELECT sstr( spoly( '{(10d,0d),(10d,1d),(15d,0d)}' ), "DEG", 8 );

SELECT sstr( spoly( '{(359d,0d),(359d,1d),(4d,0d)}' ), "DEG", 8 );
...
SELECT sstr( spoly_aggr(data.p), "DEG", 8 ) FROM ( SELECT spoint( '(0,1)' ) as p UNION ALL SELECT spoint( '(1,1)' ) UNION ALL SELECT spoint( '(1,0)' ) ) AS data ;
