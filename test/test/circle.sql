...
SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1.0d >'), "RAD", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1d 30m >'), "RAD", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 0.1 >'), "RAD", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 90d >'), "RAD", 8);


SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1.0d >'), "DEG", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1d 30m >'), "DEG", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 0.1 >'), "DEG", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 90d >'), "DEG", 8);


SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1.0d >'), "DMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1d 30m >'), "DMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 0.1 >'), "DMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 90d >'), "DMS", 8);


SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1.0d >'), "HMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 1d 30m >'), "HMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 0.1 >'), "HMS", 8);

SELECT sstr(scircle( '< (1h 2m 30s , +1d 2m 30s), 90d >'), "HMS", 8);
...
SELECT sstr(scenter(scircle( '< (1h 2m 30s , +1d 2m 30s), 1.0d >')), "DMS", 8);

SELECT sstr(scenter(scircle( '< (1h 2m 30s , +90d 0m 0s), 1.0d >')), "DMS", 8);



-- scircle scircle(spoint)

SELECT sstr(scircle(spoint( '(0d,0d)' )), "DMS", 8);

SELECT sstr(scircle(spoint( '(0d,90d)' )), "DMS", 8);
...
SELECT sstr(scenter( scircle( '< (1h 2m 3s , +1d 2m 3s), 1.0d >') ), "DMS", 8);

SELECT sstr(scenter( scircle( '< (1h 2m 3s , +90d 0m 0s), 1.0d >') ), "DMS", 8);
